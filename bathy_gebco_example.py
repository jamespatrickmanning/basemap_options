...
ax.scatter(lons, lats, zorder=5, color="red", label="Wahle Lab Settlement Traps collected")
...
sub_ax = plt.axes(
    [0.4, 0.4, 0.2, 0.2], projection=ccrs.Stereographic(central_latitude=43., central_longitude=-68.)
)
